              ...
              <div class="col-4 col-md-2">
                ...
                <div class="col-8 col-md-8">
                  ...
                  <ul>
                      ...
                      <li class="nav-item"><a class="pisen-nav-link active" href="contact.php">Contact</a></li>
                    </ul>
                  </nav>
                </div>
				...
				<div class="row mt-5">
					<div class="col-md-12">
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<textarea name="" id="message" cols="30" rows="6" class="form-control" placeholder="Message"></textarea>
								</div>
								<div class="form-group">
